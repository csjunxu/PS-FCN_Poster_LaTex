...
\headerbox{\bf\color{blue} Problem Definition and Contribution}{name=contribution,column=0,row=0,span=2}{
    ...
    \vspace{-0em}
    \textbf{\color{blue}Key Motivations and Contributions:}
    \begin{itemize}
        \item Realistic noise is signal dependent (much more complex than AWGN);
        \item Reveal the channel-wise statistics and locally signal dependent property of the realistic noise;
        \item Propose a trilateral weighted sparse coding (TWSC) scheme for real-world image denoising;
